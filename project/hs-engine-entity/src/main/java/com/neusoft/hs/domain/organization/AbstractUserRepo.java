...
interface AbstractUserRepo extends
	...
	@Query("select d from Doctor d where d.dept in (:depts)")
	List<Doctor> findDoctor(@Param("depts") List<Dept> depts, Pageable pageable);
	...
	Staff findStaff(@Param("id") String id);
}
